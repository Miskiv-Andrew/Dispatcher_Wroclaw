...
private slots:
    ...
    // ------------------------------------------------------------------------
    // Обновляет состояние иконки в системном трее.
    //
    // Левая половина показывает состояние соединения с ПЛК.
    // Правая половина показывает наличие Python-клиента.
    //
    // Метод вызывается автоматически при изменении состояния
    // ModBusClient или LocalServer.
    // ------------------------------------------------------------------------
